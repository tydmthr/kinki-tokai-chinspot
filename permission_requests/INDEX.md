...
| fest-116 | 六郷のカマクラ | 秋田県美郷町 | **`public`** ✅ | あきた美郷づくり 荒田様（窓口）／六郷のカマクラ行事継承会（権利者） | 写真提供　六郷のカマクラ行事継承会 | **送信済2026-06-10**（お礼＋お詫び、msg `19eafbd4ce700355`）／返信待ち |
| fest-117 | 白石踊 | 岡山県笠岡市白石島 | **`public`** ✅ | 笠岡市教委 安東康宏様 | 写真提供　笠岡市教育委員会 | **送信済2026-06-10**（お礼＋確認URL報告、msg `19eafbc8afb247b1`）／返信待ち |
| fest-118 | 御陣乗太鼓？（仮） | 石川県輪島市（推定） | `unspecified_hold` | 未特定 | — | 対象スポット要特定 |
| fest-149 | サバー送り（北浦地方のサバー送り） | 山口県長門市 | **`sent`** 🟡 | 長門市観光コンベンション協会 info@nanavi.jp（副・**送信済2026-06-08**）／長門市役所 文化財保護室（一次・フォーム送付待ち） | 未定 | 観光協会回答待ち＋文化財保護室フォーム送付（`sent/fest-149_nagato-kanko-kyokai_2026-06-08_request.md`） |
| fest-157 | 木境大物忌神社の虫除け祭り | 秋田県由利本荘市矢島町 | **`sent`** 🟡 | 由利本荘市 文化・スポーツ課 sports@city.yurihonjo.lg.jp（**送信済2026-06-08**）／木境大物忌神社 0184-55-3249（電話未実施） | 未定 | 市側回答待ち＋神社直電話タイミング判断 |
| fest-170 | 古和浦祇園祭・船形神輿 | 三重県度会郡南伊勢町（地元エリア） | **`sent`** 🟡 | 南伊勢町観光協会 フォーム経由（**送信済2026-06-08**）／古和浦祇園祭保存会 IG @kowauragionsai（地縁ルート保留） | 未定 | 観光協会回答待ち（3営業日目安）＋必要なら商工会ルートに切替判断 |
